...
export const Gogostory = () => {
  return (
    <div className="gogostory">
      <div className="sectionTittle">
        <p>GoGo</p>
        <p>СТОРИ</p>
      </div>
      <div className="gogoFlex">
        {gogoArr.map((gogo) => {
          let backimage = {
            backgroundImage: "url(" + gogo.img + ")",
          };
          return (
            <div className="gogostoryContent">
              <div className="gogoContent-img" style={backimage}></div>
              <div className="gogoContentImf">
                <p className="imf-p">{gogo.imf}</p>
